...
import { STRUCTURE_OBJECTS } from "./structures";
...
const galaxies: CatalogObject[] = [
  ...
  galaxy({
    ...
    description:
      "A giant elliptical galaxy that swallowed a spiral — its dust lane is the leftover. Its central black hole fires radio jets over a million light-years long.",
    facts: [
      ["Distance", "~12 million ly"],
      ["Central black hole", "~55 million M☉"],
      ["Radio lobes", "~1 million ly"],
    ],
    ra: "13h25m27.6s",
    dec: "-43°01′09″",
    distanceMly: 12.4,
  ...
  galaxy({
    ...
    facts: [
      ["Distance", "~31 million ly"],
      ["Diameter", "~49,000 ly"],
      ["Central black hole", "~1 billion M☉"],
    ],
    ra: "12h39m59.4s",
    dec: "-11°37′23″",
    distanceMly: 31,
  ...
  galaxy({
    ...
    description:
      "Two galaxies in mid-collision, flinging out long tails of stars. The crash is triggering billions of new stars. This is a preview of what may happen to the Milky Way and Andromeda.",
    facts: [
      ["Distance", "~45–65 million ly (disputed)"],
      ["Tidal tails", "~500,000 ly span"],
    ],
    ra: "12h01m53.0s",
    dec: "-18°52′10″",
    distanceMly: 45,
  ...
  galaxy({
    ...
    description:
      "A smaller galaxy punched straight through it about 400 million years ago, sending a ring of star formation rippling outward like a stone dropped in a pond.",
    facts: [
  ...
  galaxy({
    ...
    facts: [
      ["Distance", "~1.05 billion ly"],
      ["Diameter", "~2–4 million ly (diffuse halo, disputed)"],
    ],
    ra: "15h10m56.1s",
    dec: "+05°44′41″",
    distanceMly: 1045,
...
const clustersAndVoids: CatalogObject[] = [
  {
    ...
    facts: [
      ...
      ["Nearby cluster", "Norma (Abell 3627)"],
      ["Supercluster", "Laniakea, ~520 million ly"],
    ],
...
const quasars: CatalogObject[] = [
  quasar({
    ...
    description:
      "The first quasar ever identified (Maarten Schmidt, 1963) and the brightest in our sky — visible in a backyard telescope despite being billions of light-years away. Its jet stretches ~200,000 light-years.",
    facts: [
      ["Black hole", "~890 million M☉"],
      ["Luminosity", "~4 trillion L☉"],
    ],
    ra: "12h29m06.7s",
    dec: "+02°03′09″",
    z: 0.158,
  ...
  quasar({
    ...
    facts: [
      ["Black hole", "~40 billion M☉ (some estimates ~66 billion)"],
      ["Event horizon diameter", "~1,600 AU"],
      ["Luminosity", "~100 trillion L☉"],
    ],
    ra: "12h28m24.9s",
    dec: "+31°28′38″",
    z: 2.219,
...
const edge: CatalogObject[] = [
  {
    ...
    facts: [
      ["Radius (comoving)", "~46.5 billion ly"],
      ["Age of universe", "13.8 billion yr"],
      ["Galaxies inside", "~2 trillion (est.)"],
    ],
...
export const COSMIC_CATALOG: CatalogObject[] = [...localGroup, ...galaxies, ...STRUCTURE_OBJECTS, ...clustersAndVoids, ...quasars, ...edge];
